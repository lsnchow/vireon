...
/** Mini footprint SVG preview for a building template. */
  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed left-4 top-4 z-50 flex items-center gap-2 rounded-lg bg-[#12121a]/90 px-3 py-2 text-sm font-medium text-[#e8e8f0] shadow-lg backdrop-blur-md transition-colors hover:bg-[#1a1a2e] border border-[#2a2a3e]"
        >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-[#9898b0]">
                        {template.floors}F · {template.defaultHeight}m
                      </span>
                    </div>
